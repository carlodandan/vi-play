      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        >
          ...
          <p className="text-zinc-400 leading-relaxed text-xs">
            <strong className="text-zinc-200">VPlay</strong> is an open-source
            demonstration application built exclusively for{" "}
            <strong className="text-white">
              entertainment and educational purposes
            </strong>
            . VPlay does not host, stream, scrape, upload, or store media files
        ...
        <div className="text-center text-zinc-700 text-[11px] pt-2">
          <p>
            © {new Date().getFullYear()} VPlay · For Entertainment Purposes Only
            · All Rights Reserved
          </p>
        </div>
      </div>
